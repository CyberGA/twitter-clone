        ...
        <div className={style.bioContainer}>
          ...
          <div className={style.post_content}>
            ...
            <div className={style.post_utils}>
              ...
              <div className={`${style.postIcons} ${style.likeIcon}`}>
                <svg
              ...
              <div className={`${style.postIcons} ${style.shareIcon}`}>
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg" className={style.icon}
                >
                  <g transform="matrix(1, 0, 0, 1, 422.010132, 179.950241)" className={style.iconChild} >
